...
class GetTrainNums(object):
    ...
    def get_train_text(self):
        ...
        r = requests.get('https://kyfw.12306.cn/otn/lcxxcx/query?purpose_codes=ADULT&queryDate='\
            +self.date+'&from_station='+self.from_station +'&to_station=' + self.to_station, verify=False).text
        return r
    ...
    def get_train_no(self):
        ...
        df_use.to_csv('./data/yy.csv', mode = 'a',index=False,header=False,encoding='utf-8')
...
if __name__ == '__main__':
    ...
    to_station = 'NJH'
    date= '2016-12-29'
    out_csv = './date/train_names2.csv'
    
    js = GetTrainNums(from_station,to_station,date)
    # num = js.get_train_text()
    js.get_train_no()
